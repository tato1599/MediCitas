...
<footer class="p-4 bg-white md:p-8 lg:p-10 ">
    <div class="mx-auto max-w-screen-xl text-center">
        ...
        <p class="my-6 text-gray-500 ">
            Medicitas es una plataforma de gestión de citas médicas que te ayuda a organizar y optimizar tu tiempo.
        </p>
        ...
        <span class="text-sm text-gray-500 sm:text-center ">© 2025 <a href="#" class="hover:underline">Medicitas™</a>. All Rights Reserved.</span>
    </div>
  </footer>
